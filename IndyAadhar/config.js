...
const config = {
    ...
    walletName: `${process.env.USERNAME || 'mario'}_wallet`,
    ...
    userInformation: {
        name: process.env.NAME || 'Mario Jones',
        email: process.env.EMAIL || 'mario@india.gov',
        ...
        username: process.env.USERNAME || 'mario',
